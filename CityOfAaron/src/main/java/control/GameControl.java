...
public class GameControl {
    ...
    /**
     * Generates a random number with lowNumber and highNumber
     * requirements: the highNumber and lowNumber must be greater than zero
     * highNumber has to be greater than the lowNumber
     * highNumber can't be higher than the MAX_VALUE
     * @param lowValue
     * @param highValue
